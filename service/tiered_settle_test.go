...
func TestPrepareTieredBillingForSelectedGroupRejectsInsufficientRetryTopUp(t *testing.T) {
	truncate(t)

	const userID = 701
	// Balance covers neither the already-reserved 50k nor the new 50k top-up.
	// A proactive retry must not create an implicit wallet credit line.
