...
func truncate(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		model.DB.Exec("DELETE FROM hub_supply_groups")
		model.DB.Exec("DELETE FROM hub_providers")
		...
		model.DB.Exec("DELETE FROM billing_task_settlements")
