...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		publicTenantHost := middleware.TenantHostContextRequired()
		apiRouter.GET("/hub/public/providers/:slug", publicTenantHost, controller.GetPublicHubProvider)
		apiRouter.GET("/hub/public/providers/:slug/logo", publicTenantHost, controller.GetPublicHubProviderLogo)
		...
		apiRouter.GET("/hub/public/home", middleware.TenantHostContextRequired(), controller.GetPublicHubHome)
		apiRouter.GET("/hub/public/brand", middleware.TenantHostContextRequired(), controller.GetPublicHubTenantBrand)
		apiRouter.GET("/hub/public/business-contact", middleware.TenantHostContextRequired(), controller.GetPublicHubBusinessContact)
		apiRouter.GET("/hub/public/brand-assets/:asset_id", middleware.TenantHostContextRequired(), controller.GetPublicHubTenantBrandAsset)
		...
		hubProviderRoute.Use(middleware.TenantHostContext(), middleware.UserAuth())
		{
			...
			hubProviderRoute.DELETE("/channels/:id/failed-models", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.DeleteHubProviderChannelFailedModels)
			hubProviderRoute.POST("/channels/:id/missing-price-notification", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.NotifyHubProviderChannelMissingModelPrices)
		...
		systemTaskRoute.Use(middleware.RootAuth())
		{
			...
			systemTaskRoute.POST("/weekly-business-digest/retry", controller.RetryFailedHubWeeklyDigestSystemTask)
