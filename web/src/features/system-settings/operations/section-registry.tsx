...
import { ProviderNotificationSettingsSection } from '../integrations/provider-notification-settings-section'
...
const OPERATIONS_SECTIONS = [
  ...
  },
  {
    ...
    titleKey: 'Provider Notifications',
    build: () => <ProviderNotificationSettingsSection />,
  },
  {
    id: 'worker',
