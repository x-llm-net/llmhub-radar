...
const defaultModelSettings: ModelSettings = {
  ...
  'hub_public_home.model_blacklist': '["codex-auto-review"]',
  ...
  'hub_routing_setting.enabled': true,
  'hub_routing_setting.allow_other_family': false,
  'hub_routing_setting.family_tier_ceilings': '{}',
  'hub_routing_setting.high_quality_provider_ids': '[]',
  ModelPrice: '',
  ModelRatio: '',
  CacheRatio: '',
  CreateCacheRatio: '',
