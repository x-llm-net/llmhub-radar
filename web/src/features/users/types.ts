...
export const userSchema = z.object({
  ...
  registration_tenant_id: z.number().optional(),
  registration_provider_id: z.number().optional(),
  registration_source: z.string().optional(),
  registration_tenant_name: z.string().optional(),
  registration_provider_name: z.string().optional(),
