...
const (
	...
	MsgTokenServiceTierRequired   = "token.service_tier_required"
	MsgTokenRoutingPolicyRequired = "token.routing_policy_required"
	MsgTokenRoutingScopeMismatch  = "token.routing_scope_mismatch"
)
...
const (
	...
	MsgHubProviderWebsiteRequired            = "hub_provider.website_required"
	MsgHubProviderWebsiteVerificationInvalid = "hub_provider.website_verification_invalid"
	...
	MsgHubProviderTrustedTenantDomainRequired = "hub_provider.trusted_tenant_domain_required"
	MsgHubProviderTenantIDRequired            = "hub_provider.tenant_id_required"
	MsgHubProviderTenantIDMismatch             = "hub_provider.tenant_id_mismatch"
