...
type UserSetting struct {
	...
	WeeklyProviderDigestEnabled      *bool   `json:"weekly_provider_digest_enabled,omitempty"`       // 是否接收渠道商每周经营报告，nil 为默认开启
	WeeklyTenantDigestEnabled        *bool   `json:"weekly_tenant_digest_enabled,omitempty"`         // 是否接收总代每周经营报告，nil 为默认开启
