...
func Relay(c *gin.Context, relayFormat types.RelayFormat) {
	...
	for ; retryParam.GetRetry() <= common.RetryTimes; retryParam.IncreaseRetry() {
		...
		if service.IsHubServiceTierRequest(c) {
			service.ClearCurrentChannelAffinityCacheForRetry(c)
		}
...
func RelayTask(c *gin.Context) {
	...
	if taskErr == nil {
		...
		task.PrivateData.BillingContext = &model.TaskBillingContext{
			...
			SupplyBillingRatio:               relayInfo.PriceData.GroupRatioInfo.SupplyGroupRatio,
			HasSupplyPricing:                 relayInfo.PriceData.GroupRatioInfo.HasSupplyPricing,
			FallbackPriceProtection:          relayInfo.PriceData.GroupRatioInfo.FallbackPriceProtection,
			...
			SupplyTenantId:                   relayInfo.PriceData.GroupRatioInfo.SupplyTenantId,
			ProviderServiceFeeBasisPoints:    relayInfo.PriceData.GroupRatioInfo.ProviderServiceFeeBasisPoints,
			HasProviderServiceFeeBasisPoints: relayInfo.PriceData.GroupRatioInfo.HasProviderServiceFeeBasisPoints,
